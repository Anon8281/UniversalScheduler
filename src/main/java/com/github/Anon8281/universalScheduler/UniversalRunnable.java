...
public abstract class UniversalRunnable implements Runnable {
     ...
     */
    @NotNull
    public synchronized MyScheduledTask runTask(@NotNull Plugin plugin) throws IllegalArgumentException, IllegalStateException {
     ...
     */
    @NotNull
    public synchronized MyScheduledTask runTaskAsynchronously(@NotNull Plugin plugin) throws IllegalArgumentException, IllegalStateException {
        checkNotYetScheduled();
     ...
     */
    @NotNull
    public synchronized MyScheduledTask runTaskLater(@NotNull Plugin plugin, long delay) throws IllegalArgumentException, IllegalStateException {
        checkNotYetScheduled();
     ...
     */
    @NotNull
    public synchronized MyScheduledTask runTaskLaterAsynchronously(@NotNull Plugin plugin, long delay) throws IllegalArgumentException, IllegalStateException {
        checkNotYetScheduled();
     ...
     */
    @NotNull
    public synchronized MyScheduledTask runTaskTimer(@NotNull Plugin plugin, long delay, long period) throws IllegalArgumentException, IllegalStateException {
        checkNotYetScheduled();
     ...
     */
    @NotNull
    public synchronized MyScheduledTask runTaskTimerAsynchronously(@NotNull Plugin plugin, long delay, long period) throws IllegalArgumentException, IllegalStateException {
        checkNotYetScheduled();
    ...
    @NotNull
    private MyScheduledTask setupTask(@NotNull final MyScheduledTask task) {
        this.task = task;
        return task;
    }
